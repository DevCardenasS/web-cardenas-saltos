...
const WhatsAppButton = () => {
  ...
  return (
    <>
      ...
      >
        {/* SVG con la alineación que funciona bien */}
        <svg 
        ...
        {/* 2. Tooltip mantenido para desktop */}
        <span className="absolute right-20 bg-white text-[#051d40] text-sm font-bold px-4 py-2 rounded-xl shadow-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap hidden md:block border border-gray-100">
