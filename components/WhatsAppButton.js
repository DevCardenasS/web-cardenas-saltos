...
const WhatsAppButton = () => {
  // Mensaje personalizado centralizado
  ...
  return (
    <>
      ...
      <a
        ...
        // He ajustado flex, items-center y justify-center para alineación perfecta
        className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-[999] bg-[#25d366] w-16 h-16 md:w-16 md:h-16 rounded-full shadow-2xl hover:scale-110 transition-transform flex items-center justify-center animate-shine"
        aria-label="Chat on WhatsApp"
      >
        {/* SVG centrado con dimensiones fijas */}
        <svg 
