  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-[999] bg-[#25d366] w-14 h-14 md:w-16 md:h-16 rounded-full shadow-2xl hover:scale-110 transition-transform flex items-center justify-center animate-shine"
        aria-label="Chat on WhatsApp"
      >
        {/* Contenedor del SVG para asegurar centrado total */}
