    ...
    <div className="w-full bg-white font-['Gantari']">
          ...
          <div className="max-w-[550px] w-full text-left">
            ...
            <div className="mt-10">
              <a 
                ...
                onClick={() => handleConversion("Home - Hero Principal")} // <--- ETIQUETA AÑADIDA
                target="_blank"
      ...
      <section className="w-full py-20 px-6 bg-[#f2f2f2]">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8">
          <ServiceCard 
            ...
            link="https://cardenassaltos.com/administrativo"
            phoneNumber={WHATSAPP_NUMBER}
            whatsappMessage={whatsappMessage}
            onConvert={() => handleConversion("Home - Tarjeta Administrativo")} // <--- ETIQUETA AÑADIDA
          />
          <ServiceCard 
            ...
            link="https://cardenassaltos.com/constitucional"
            phoneNumber={WHATSAPP_NUMBER}
            whatsappMessage={whatsappMessage}
            onConvert={() => handleConversion("Home - Tarjeta Constitucional")} // <--- ETIQUETA AÑADIDA
          />
          <ServiceCard 
            title="Notarías" 
            ...
            link="https://cardenassaltos.com/notarial"
            phoneNumber={WHATSAPP_NUMBER}
            whatsappMessage={whatsappMessage}
            onConvert={() => handleConversion("Home - Tarjeta Notarial")} // <--- ETIQUETA AÑADIDA
          />
          <ServiceCard 
            title="Mediación" 
            ...
            link="https://cardenassaltos.com/mediacion"
            phoneNumber={WHATSAPP_NUMBER}
            whatsappMessage={whatsappMessage}
            onConvert={() => handleConversion("Home - Tarjeta Mediacion")} // <--- ETIQUETA AÑADIDA
          />
        </div>
      </section>
      ...
      <section className="w-full bg-[#ffbd4a] py-24">
        <div className="max-w-7xl mx-auto px-6 text-left">
          ...
          <a 
            href={`https://wa.me/${WHATSAPP_NUMBER}?text=${whatsappMessage}`} 
            onClick={() => handleConversion("Home - Banner Final")} // <--- ETIQUETA AÑADIDA
            target="_blank"
            rel="noopener noreferrer"
...
function ServiceCard({ title, desc, img, link, phoneNumber, whatsappMessage, onConvert }) {
  return (
    <div className="bg-[#051d40] rounded-3xl overflow-hidden flex flex-col lg:flex-row min-h-[380px] shadow-2xl group border border-white/5">
      ...
      <div className="p-8 lg:w-1/2 text-white flex flex-col justify-between order-last lg:order-first">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <a 
            href={link}
            className="border border-white/50 text-white px-6 py-3 text-[11px] rounded-full font-normal hover:bg-white hover:text-[#051d40] transition w-full sm:w-auto uppercase tracking-wider text-center flex items-center justify-center"
          >
            Ver más
          </a>
          <a 
