  ...
  const servicios = [
    ...
    },
    {
      ...
      beneficios: [
        ...
        "Paz entre las Partes: Terminar la relación arrendataria sin violencia ni rencores." //
      ]
    }
  ];
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start gap-12">
          ...
          <div className="lg:w-1/2 order-1">
            <p className="text-[#051d40] text-lg md:text-xl leading-relaxed mb-8 font-normal pt-2">
              Resuelve tus conflictos de forma rápida y económica sin juicios. Logra acuerdos legales en pensión alimenticia, visitas, tenencia, deudas y liquidaciones laborales con total validez ante la ley.
            </p>
